...
class TaskData extends Extra {
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (title,description,project_id,category_id,user_id,is_done,created_at) ";
		$sql .= "value (\"$this->title\",\"$this->description\",$this->project_id,$this->category_id,$this->user_id,$this->is_done,$this->created_at)";
